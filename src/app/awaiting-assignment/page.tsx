...
export default function AwaitingAssignmentPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FFFDF9] flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-sm bg-white border border-[#EADBCE] rounded-2xl p-8 sm:p-10 shadow-lg text-center">
                <div className="w-16 h-16 rounded-full bg-amber-50 border border-amber-200 text-amber-600 mx-auto flex items-center justify-center mb-6 shadow-xs">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                        <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
                    </svg>
                </div>
                <h2 className="text-xl font-bold text-[#2B1413] mb-3">รอการกำหนดสาขา</h2>
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        disabled={loading}
                        className="w-full py-3 px-4 rounded-xl font-bold bg-[#2B1413] text-amber-300 hover:bg-[#442220] disabled:opacity-50 transition-colors shadow-sm cursor-pointer flex items-center justify-center gap-2"
                    >
                        {loading ? (
                    ...
                    <button
                        ...
                        onClick={() => logout()}
                        disabled={loading}
                        className="w-full py-3 px-4 rounded-xl font-semibold bg-[#FAF4EC] text-[#78483B] hover:bg-[#F2E7DC] hover:text-[#2B1413] border border-[#EADBCE] disabled:opacity-50 transition-colors cursor-pointer"
                    >
                        กลับสู่หน้าล็อกอิน
                    </button>
                </div>
